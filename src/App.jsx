...
const PRODOTTI = [
  { emoji:"🐾", nome:"PawBalm",      cat:"Zampe",      prezzo:12.90, tag:"Best Seller", tagCol:"#b8603a",
    desc:"Balsamo protettivo per le zampe. Idrata e ripara le screpolature causate da caldo, freddo e asfalto." },
  { emoji:"🧴", nome:"FurShampoo",   cat:"Igiene",     prezzo:16.50, tag:"Novità",      tagCol:"#2d4a2d",
    desc:"Shampoo delicato per pelo lungo e corto. Formula ipoallergenica senza parabeni, lascia il manto morbido e profumato." },
  { emoji:"✨", nome:"CoatSerum",    cat:"Pelo",        prezzo:22.00, tag:"Top",         tagCol:"#7b3ab8",
    desc:"Siero lucidante per il pelo. Nutre in profondità, riduce i nodi e dona una lucentezza visibile dalla prima applicazione." },
  { emoji:"🦷", nome:"DentaFresh",   cat:"Igiene",     prezzo:9.90,  tag:null,          tagCol:null,
    desc:"Gel dentale enzimatico per cani e gatti. Combatte la placca e l'alito cattivo senza bisogno di spazzolino." },
  { emoji:"🌿", nome:"CalmDrops",    cat:"Benessere",  prezzo:24.90, tag:"Esclusivo",   tagCol:"#2980b9",
    desc:"Gocce calmanti a base di valeriana e camomilla. Riducono ansia e stress in situazioni come viaggi e temporali." },
  { emoji:"🐶", nome:"SkinRelief",   cat:"Dermatologia",prezzo:19.90, tag:null,         tagCol:null,
    desc:"Lozione lenitiva per pelle irritata o secca. Indicata per dermatiti, prurito e zone sensibili. Sicura se leccata." },
  { emoji:"🐱", nome:"EarClean",     cat:"Igiene",     prezzo:11.50, tag:null,          tagCol:null,
    desc:"Soluzione detergente per orecchie. Rimuove cera e impurità in modo delicato, prevenendo infezioni e cattivi odori." },
  { emoji:"💊", nome:"VitaBoost",    cat:"Benessere",  prezzo:26.00, tag:"Promo",       tagCol:"#e67e22",
    desc:"Integratore multivitaminico in pastiglie appetibili. Supporta il sistema immunitario, le articolazioni e il pelo." },
];
const USCITE = [
